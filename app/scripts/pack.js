(function () {
    ...
    Pack.prototype.buildElement = function () {
        ...
        this.message = (function (container) {
            var msgElt = new $derby.SvgElement('text', {
                fill: '#000000',
        ...
        this.delimiter = (function (container) {
            var delimiter = new $derby.SvgElement('path', {
                d: 'M 0,0'
            });

            var packElt = new $derby.SvgElement('g', {
                class: 'pack-track',
                'fill-rule': 'evenodd',
            ...
            // Track limit
            packElt.appendChild(new $derby.SvgElement('path', {
                class: 'limit',
            ...
            container.appendChild(new $derby.SvgElement('clipPath', {
                id: 'pack-' + this.id
            }, delimiter));
