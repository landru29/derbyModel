    ...
    var Bench = function(scene, options) {
        ...
        if (this.opt.position==0) {
            this.chairs = [
                ...
                new $derby.Chair({x:1500, y:-730}),
                new $derby.Chair({x:1550, y:-680}),
                new $derby.Chair({x:1600, y:-630})
            ];
        } else {
            this.chairs = [
                new $derby.Chair({x:1400, y:800}),
                new $derby.Chair({x:1450, y:750}),
                new $derby.Chair({x:1500, y:700}),
                new $derby.Chair({x:1550, y:650}),
                new $derby.Chair({x:1600, y:600})
            ];
        }
